...
class Weather_Station():
    def __init__(self, station_id):
        ...
        #### backend URL's #######
        self.url_data  = f'http://uoa-wsn.i-met.gr//station//store_data.php?'
        self.url_telem = f'http://uoa-wsn.i-met.gr//station//telemetry.php?'

        self.url_cmdRX = f'http://uoa-wsn.i-met.gr//station//command//cmdTrans.php?&st={station_id}'
        self.url_cmdTX = f'http://uoa-wsn.i-met.gr//station//command//cmdRec.php?'
        ##########################
