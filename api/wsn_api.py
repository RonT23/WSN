...
class Weather_Station_Backend_Controller:
    def __init__(self):
        '''
            sets the route URL's for the different backend handlers
        '''
        ...
        self.url_cmdTX    = f"http://uoa-wsn.i-met.gr//station//command//cmdRec.php?"               # route URL for the command transmiter handler
